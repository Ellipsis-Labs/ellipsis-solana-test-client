...
use crate::banks_client_interface::ParsedTransaction;
pub use crate::banks_client_interface::{
...
impl BanksClient {
    ...
    pub fn get_transaction(
        &mut self,
        signature: Signature,
    ) -> impl Future<Output = Result<Option<ParsedTransaction>, BanksClientError>> + '_ {
        self.inner
            .get_transaction_with_commitment(context::current(), signature)
            .map_err(Into::into)
    }
}
